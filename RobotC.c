...
#pragma config(Motor,  port1,           leftMotor,     tmotorVex393_HBridge, openLoop) // removed driveLeft (was causing compile errors)
#pragma config(Motor,  port2,           rightMotor,    tmotorVex393_MC29, openLoop, reversed) // removed driveRight
...
//Lol it was more like 40-60 but thanks for the credit (fixed some compile time errors 12/7)
